...
public class TextFile extends ArrayList<String> {
	...
	public static void write(String fileName, double[][] disMatrix)
	...
	public static List<String[]> readAsMatrix(String fileName, String splitter,
			String splitterInLine) throws IOException {
...
//				System.out.println(i);
	...
	public static void main(String[] args) throws IOException {
		...
		write3(".\\src\\io\\test.txt", file);
		TextFile text = new TextFile(".\\src\\io\\test.txt");
		text.write(".\\src\\io\\test2.txt");
		TreeSet<String> words = new TreeSet<String>(new TextFile(
				".\\src\\io\\TextFile.java", "\\W+"));
